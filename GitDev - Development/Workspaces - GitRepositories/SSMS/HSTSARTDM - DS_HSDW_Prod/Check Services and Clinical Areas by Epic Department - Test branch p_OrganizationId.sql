...
SELECT DISTINCT COALESCE(ids.organization_id,0) AS organization_id, COALESCE(organization.organization_name,'Unmapped') AS organization_name
FROM
(
...
WHERE 1=1
ORDER BY COALESCE(ids.organization_id,0);