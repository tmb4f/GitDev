...
-- 6/4/2024
SELECT DISTINCT
-- COALESCE(org.organization_id,0) AS organization_id
--,COALESCE(org.organization_name,'Unmapped') AS organization_name
--,COALESCE(org.service_id,0) AS service_id
--,COALESCE(org.[service_name],'Unmapped') AS [service_name]
--,COALESCE(org.clinical_area_id,0) AS clinical_area_id
--,COALESCE(org.clinical_area_name,'Unmapped') AS clinical_area_name
 org.organization_id
,org.organization_name
,org.service_id
,org.[service_name]
...
FROM
(
--SELECT DISTINCT ca.EPIC_DEPARTMENT_ID, ca.sk_Ref_Clinical_Area_Map, ca.clinical_area_id, ca.clinical_area_name, ca.sk_Ref_Service_Map, [service].service_id, [service].[service_name], [service].organization_id organization_id
...
FROM
(
--SELECT DISTINCT mapping.EPIC_DEPARTMENT_ID, mapping.sk_Ref_Clinical_Area_Map, clinical_area.clinical_area_id, clinical_area.clinical_area_name, clinical_area.sk_Ref_Service_Map AS sk_Ref_Service_Map
...
--				  , org.clinical_area_id
--				  , mdm.EPIC_DEPARTMENT_ID;
--ORDER BY COALESCE(org.organization_id,0)
--                  , COALESCE(org.service_id,0)
--				  , COALESCE(org.clinical_area_id,0)
--				  , mdm.EPIC_DEPARTMENT_ID;
ORDER BY org.organization_id
                  , org.service_id
				  , org.clinical_area_id
