...
SET @StartDate = '4/1/2025'
SET @EndDate = '4/30/2025'
...
--ORDER BY HOSPITAL_CODE, DEPARTMENT_NAME;
ORDER BY HOSPITAL_CODE, DEPARTMENT_NAME, evs_cte.BED_ID, evs_cte.TimeDirty;
--*/
GO