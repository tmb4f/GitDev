...
SET @HierarchyValues = '10' --	Gastroenterology -- Test
...
SET @Departments = '10243003' --  UVHE DIGESTIVE HEALTH -- Test
...
SET @Providers = '46614' -- TUSKEY, ANNE'
...
--*--SELECT @Providers AS ProvidersSelect
   ...
   INTO #avail_slot
	...
	LEFT OUTER JOIN CLARITY..CLARITY_SER ser			ON avail.PROV_ID = ser.PROV_ID
	...
	LEFT OUTER JOIN clarity..ZC_PROV_TYPE					    ON zc_prov_type.PROV_TYPE_C = ser.PROVider_TYPE_C
   ...
   WHERE 1=1
	...
	--AND avail.SLOT_DATE = '11/19/2024'
...
LEFT OUTER JOIN CLARITY..CLARITY_SER ser						ON blk.PROV_ID = ser.PROV_ID
   WHERE 1=1
	AND ( 
	...
	--AND CAST(blk.SLOT_BEGIN_TIME AS DATE) = '11/19/2024'
