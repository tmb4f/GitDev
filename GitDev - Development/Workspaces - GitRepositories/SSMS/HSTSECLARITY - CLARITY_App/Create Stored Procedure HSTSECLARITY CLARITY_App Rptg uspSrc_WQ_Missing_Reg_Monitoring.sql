...
CREATE PROCEDURE [Rptg].[uspSrc_WQ_Missing_Reg_Monitoring]
    (
     @StartDate DATE = NULL
    ,@EndDate DATE = NULL
	,@WQ VARCHAR(18) = NULL
...
--/**********************************************************************************************************************
--WHAT: Create procedure Rptg.uspSrc_WQ_Missing_Reg_Monitoring
--WHO : Tom Burgan
--WHEN: 2/11/25
...
--                
--      OUTPUTS:  [Rptg].[uspSrc_WQ_Missing_Reg_Monitoring]
-- 
--------------------------------------------------------------------------------------------------------------------------
--MODS: 	
...
SELECT
	...
	REGHX.REG_HX_USER_ID,
	REGHX.REG_HX_LOGIN_DEP_ID,
	CLARITY.EPIC_UTIL.EFN_UTC_TO_LOCAL(REGHX.REG_HX_INST_UTC_DTTM) AS REG_HX_INST_LOCAL_DTTM,
