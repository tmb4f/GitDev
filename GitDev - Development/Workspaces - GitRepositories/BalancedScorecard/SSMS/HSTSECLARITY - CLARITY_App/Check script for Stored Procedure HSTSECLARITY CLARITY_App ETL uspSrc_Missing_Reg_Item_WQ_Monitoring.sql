...
SELECT
	...
	,   emp_entry.NAME AS 'ENTRY_USER_NAME'
	,	wqux.USER_ID 'EXIT_USER'
	,   emp_exit.NAME AS 'EXIT_USER_NAME'
...
FROM CLARITY..PAT_WQ_ITEMS		pawi			
		...
		LEFT JOIN	CLARITY..CLARITY_EMP emp_entry ON emp_entry.USER_ID = COALESCE(wquh.USER_ID,wqxe.USER_ID,wqxe2.USER_ID)
		LEFT JOIN	CLARITY..CLARITY_EMP emp_exit ON emp_exit.USER_ID = wqux.USER_ID
