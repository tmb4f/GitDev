...
MODS: 	
	...
	2025/04/23 - TMB-	Edit code to generate a summary dataset
...
/*
      ...
      ,[USER_MATCH_YN]*/
,	[user].access_team_id -- INTEGER
,	[user].access_team_name -- VARCHAR(150)
,	[user].wd_Supervisory_Organization_ID -- NVARCHAR(255)
,	[user].wd_Supervisory_Organization_Description -- NVARCHAR(255)
,	wq.DEPARTMENT_ID -- existing
,	wq.WQ_USER -- VARCHAR(18)
,	[user].WQ_USER_NAME -- VARCHAR(160)
,	wq.RULE_ID -- existing
,	wq.RULE_NAME -- existing
,	wq.Entry_Count -- INTEGER
,	wq.Exit_Count -- INTEGER
INTO #TabRptg
FROM #summary wq
...
*/
FROM #TabRptg
--WHERE epic_department_id = 10419014
ORDER BY
    DEPARTMENT_ID,
    WQ_USER,
	WQ_USER_NAME,
