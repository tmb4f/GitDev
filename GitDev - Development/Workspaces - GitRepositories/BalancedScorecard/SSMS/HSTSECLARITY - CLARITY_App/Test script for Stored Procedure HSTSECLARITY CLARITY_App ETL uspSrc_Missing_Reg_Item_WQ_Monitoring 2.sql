...
WHERE pe.EFFECTIVE_DEPT_ID = 10419014
)
...
--		   ,access_team_name -- VARCHAR(150)
--		   ,wd_Supervisory_Organization_ID -- NVARCHAR(255)
--		   ,wd_Supervisory_Organization_Description -- NVARCHAR(255)
--		   ,DEPARTMENT_ID
--		   ,WQ_USER -- VARCHAR(18)
--		   ,WQ_USER_NAME -- VARCHAR(160)
--		   ,RULE_ID
--		   ,RULE_NAME
--		   ,Entry_Count -- INTEGER
--		   ,Exit_Count) -- INTEGER
