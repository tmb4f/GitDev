...
SELECT
    ...
    wq.ENTRY_USER,
	wq.ENTRY_NAME,
	wq.Entry_UVA_Computing_ID,
	wq.Entry_wd_Supervisory_Organization_ID,
	wq.Entry_wd_Supervisory_Organization_Description,
	wq.Entry_workday_supervisory_org_name,
	wq.Entry_workday_supervisory_org_id,
	wq.Entry_access_team_id,
	wq.Entry_access_team_name,
	wq.EXIT_USER,
	wq.EXIT_NAME,
	wq.Exit_UVA_Computing_ID,
	wq.Exit_wd_Supervisory_Organization_ID,
	wq.Exit_wd_Supervisory_Organization_Description,
	wq.Exit_workday_supervisory_org_name,
	wq.Exit_workday_supervisory_org_id,
	wq.Exit_access_team_id,
	wq.Exit_access_team_name,
    wq.USER_MATCH_YN,
    wq.RULE_ID,
    wq.RULE_NAME
...
WHERE detail.RN = 1
		...
		LEFT JOIN CLARITY_App.dbo.Dim_Date	dd			ON	CONVERT(DATE, COALESCE(mri.EXIT_DATE,mri.ENTRY_DATE)) = dd.day_date
