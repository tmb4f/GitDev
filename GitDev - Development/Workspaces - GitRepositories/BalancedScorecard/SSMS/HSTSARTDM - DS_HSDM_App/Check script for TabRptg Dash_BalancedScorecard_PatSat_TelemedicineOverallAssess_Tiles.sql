...
--SET @startdate = '12/1/2020 00:00:00'
SET @startdate = '7/1/2021 00:00:00'
--SET @EndDate = '6/30/2019 00:00:00'
--SET @enddate = '10/31/2020 11:59:59'
--SET @enddate = '12/31/2020 11:59:59'
SET @enddate = '11/30/2021 11:59:59'

--CREATE PROCEDURE [ETL].[uspSrc_BalancedScorecard_PatSat_Telemedicine_OverallAssess_Tiles]
--    (
...
SELECT *
FROM DS_HSDM_App.TabRptg.Dash_BalancedScorecard_PatSat_TelemedicineOverallAssess_Tiles
--WHERE
--  (event_date BETWEEN @locstartdate AND @locenddate
WHERE
   (
  (hs_area_id = 1) -- Monthly Validation
  AND (event_count = 1)
  --(event_count = 1)
...
SELECT SUM(event_score) AS x_event_score
