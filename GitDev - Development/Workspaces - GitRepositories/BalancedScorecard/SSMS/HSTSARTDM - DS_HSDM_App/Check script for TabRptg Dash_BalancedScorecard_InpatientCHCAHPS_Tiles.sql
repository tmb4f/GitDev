...
SELECT *
FROM DS_HSDM_App.TabRptg.Dash_BalancedScorecard_InpatientCHCAHPS_Tiles
--WHERE
...
SELECT SUM(CASE WHEN event_category IN ('10-Best hosp','9') THEN 1 ELSE 0 END) AS x_9_or_10_count
