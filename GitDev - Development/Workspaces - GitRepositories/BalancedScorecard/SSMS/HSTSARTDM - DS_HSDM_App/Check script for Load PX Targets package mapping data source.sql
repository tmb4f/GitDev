USE DS_HSDM_App
SELECT DISTINCT ids.EPIC_DEPARTMENT_ID, dep.Clrt_DEPt_Nme AS EPIC_DEPARTMENT_NAME, ids.sk_Ref_Clinical_Area_Map, ids.clinical_area_id, ids.clinical_area_name, ids.sk_Ref_Service_Map, ids.service_id, ids.[service_name], ids.organization_id, organization.organization_name
FROM
(
...
LEFT JOIN DS_HSDW_Prod.Rptg.vwDim_Clrt_DEPt dep
ON dep.DEPARTMENT_ID = ids.EPIC_DEPARTMENT_ID
WHERE 1=1
