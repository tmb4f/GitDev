...
SET @enddate = '8/31/2022 00:00:00'
...
SELECT *
FROM DS_HSDM_App.TabRptg.Dash_AmbOpt_CGCAHPSRecommendProvOffice_Tiles
--WHERE
...
SELECT SUM(CASE WHEN event_category = 'Yes, definitely' THEN 1 ELSE 0 END) AS x_9_or_10_count
