...
SET @EndDate = '7/31/2019 00:00:00'
...
SELECT *
--FROM DS_HSDM_App.TabRptg.Dash_BalancedScorecard_PatientProgressionTCHPlacement_Tiles
FROM DS_HSDM_App.TabRptg.Dash_BalancedScorecard_PatientProgressionEncompassPlacement_Tiles
--WHERE
...
SELECT SUM(ReferralToBookedDays) AS ReferralToBookedDays
