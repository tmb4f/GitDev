...
--EXEC [DS_HSDM_App].[ETL].[uspSrc_SvcLine_PatientProgression_EncompassPlacement]

CREATE PROCEDURE [ETL].[uspSrc_SvcLine_PatientProgression_EncompassPlacement]
    (
...
--/**********************************************************************************************************************
--WHAT: Create procedure [ETL].[uspSrc_SvcLine_PatientProgression_EncompassPlacement]
--WHO : Tom Burgan
--WHEN: 7/8/2019
--WHY : for Encompass placements : Time interval between Referral and Acceptance
--       
-------------------------------------------------------------------------------------------------------------------------
--INFO: 
...
SELECT DISTINCT
 ...
 --flags	
		CAST('Encompass_Placement' AS VARCHAR(50))				'event_type'
