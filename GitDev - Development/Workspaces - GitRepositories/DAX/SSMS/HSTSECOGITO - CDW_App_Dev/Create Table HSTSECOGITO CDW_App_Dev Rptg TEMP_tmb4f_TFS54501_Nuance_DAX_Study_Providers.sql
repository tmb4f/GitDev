...
IF EXISTS (SELECT 1 
    ...
    AND TABLE_NAME='TEMP_tmb4f_TFS54501_Nuance_DAX_Study_Provider')
...
CREATE TABLE [Rptg].[TEMP_tmb4f_TFS54501_Nuance_DAX_Study_Provider](
...
GRANT DELETE, INSERT, SELECT, UPDATE ON [Rptg].[TEMP_tmb4f_TFS54501_Nuance_DAX_Study_Provider] TO [HSCDOM\Decision Support]
GO
