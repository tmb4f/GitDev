...
--FROM PajamaTimeRaw
--ORDER BY
--	PajamaTimeRaw.ActivityDate,
--	PajamaTimeRaw.ActivityDTTM
...
PajamaMinutesPerProviderDaily AS (
    ...
    GROUP BY pt.ProviderDurableKey,pt.ProviderName,pt.ActivityDate,pt.ActivityEpicId,pt.ActivityName
), 

--SELECT
--	*
--FROM PajamaMinutesPerProviderDaily
--ORDER BY
--	PajamaMinutesPerProviderDaily.ActivityDate

ChartingDaysDaily AS (
    SELECT 
        ProviderDurableKey,
        ActivityDate,
		ChartingActivity.ActivityEpicId,
		ChartingActivity.ActivityName
    FROM ChartingActivity
    group by ProviderDurableKey,ActivityDate,ActivityEpicId,ActivityName
)
