...
--       11/17/2025 - TMB - Changed location of BUSINESS_UNIT in SELECT statement, edited IF EXISTS statement
...
, 139 -- Scheduled Inpatient Shifts
	...
	CAST(GETDATE() AS DATETIME) AS SnapShot_Dt
...
AND mdm.Seq = 1
				...
				(
					...
					FROM Rptg.vwDim_Clrt_SERsrc) sersrc
