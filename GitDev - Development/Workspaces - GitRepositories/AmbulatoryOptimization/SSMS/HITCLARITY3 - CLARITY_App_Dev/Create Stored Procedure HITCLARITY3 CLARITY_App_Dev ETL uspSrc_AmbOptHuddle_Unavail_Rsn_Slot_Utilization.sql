...
-- =====================================================================================
-- Create procedure uspSrc_AmbOptHuddle_Unavail_Rsn_Slot_Utilization
-- =====================================================================================

CREATE PROCEDURE [ETL].[uspSrc_AmbOptHuddle_Unavail_Rsn_Slot_Utilization]
    (
...
--/
IF EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'Stage.AmbOptHuddle_Dash_Unavail_Rsn_Slot_Utilization')
BEGIN
