...
--AS
	...
	DECLARE @EndDate DATETIME;
			...
			SET @EndDate = '9/16/2024 23:59:59'
...
FROM CLARITY.dbo.CLARITY_SER ser
			...
			LEFT OUTER JOIN CLARITY_App.Rptg.vwDim_Clrt_Pt clpt		ON pt.PAT_ID = clpt.Clrt_PAT_ID
