...
--			WHERE csa._UPDATE_DT >= '11/7/2024'
...
SELECT DISTINCT
	...
	pat.PAT_NAME,
	enc.sk_Dim_Pt,
	clpt.PAT_NAME AS clpt_PAT_NAME,
...
LEFT OUTER JOIN CLARITY_App.Rptg.vwDim_Clrt_Pt clpt
	ON clpt.sk_Dim_Pt = enc.sk_Dim_Pt
WHERE 1 = 1
		AND (
...
ORDER BY	CAST(enc.ucinn_ascendv2__Related_Interim_1__c AS VARCHAR(255))		
END
