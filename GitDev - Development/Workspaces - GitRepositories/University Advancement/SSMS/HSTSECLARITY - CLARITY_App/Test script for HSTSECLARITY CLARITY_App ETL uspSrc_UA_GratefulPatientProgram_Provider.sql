...
**		CLARITY.dbo.ZC_LICENSE_DISPLAY
...
MODS: 
		**		09/20/2024  -Tom B.  Create stored procedure
				...
				04/21/2025	-Tom B.  Add provider credentials column (uva_Professional_Designation__c)
...
SELECT DISTINCT  --without distinct, results multiple rows becasue diagnosis code in multiple line
	...
	--,zld.NAME																										AS	'uva_Professional_Designation__c'
