...
SELECT DISTINCT  --without distinct, results multiple rows becasue diagnosis code in multiple line
	...
	,enc.PAT_ENC_CSN_ID 'enc_PAT_ENC_CSN_ID'
	...
	,hsp.HOSP_DISCH_TIME 'Discharge_Date/Time'
	...
	,CAST(hsp.HOSP_DISCH_TIME AS DATE) 'Discharge_Date'
