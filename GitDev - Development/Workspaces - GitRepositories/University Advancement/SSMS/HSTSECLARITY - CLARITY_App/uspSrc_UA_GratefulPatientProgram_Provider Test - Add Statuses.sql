...
AND (
			(
				((pe.APPT_STATUS_C IS NOT NULL AND pe.APPT_STATUS_C IN ('1','2','3','6')) --ONLY SCHEDULED/COMPLETED/CANCELED/ARRIVED STATUS  
...
SELECT DISTINCT
    ...
    ISNULL(CONVERT(VARCHAR(255),enc.[Affiliation Data Source]),'')									AS [Affiliation Data Source],
