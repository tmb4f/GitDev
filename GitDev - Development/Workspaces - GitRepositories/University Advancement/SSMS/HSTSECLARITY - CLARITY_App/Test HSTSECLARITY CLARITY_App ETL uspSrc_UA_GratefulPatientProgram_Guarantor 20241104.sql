...
SELECT
	...
	--'UVAH-'+RIGHT('0000000'+CAST(clpt.sk_Dim_Pt AS VARCHAR(8)),8)+'-Patient-'+CONVERT(VARCHAR(8),CAST(enc.Load_Dtm AS DATE),112)	AS	'ucinn_ascendv2__Related_Interim_1__c',	
	CASE WHEN clpt.sk_Dim_Pt <> -1 THEN
		'UVAH-'+RIGHT('0000000'+CAST(clpt.sk_Dim_Pt AS VARCHAR(8)),8)+'-Patient-'+CONVERT(VARCHAR(8),CAST(enc.Load_Dtm AS DATE),112)
															  ELSE
		'UVAH-'+RIGHT('0000000'+CAST(clpt.sk_Dim_Pt AS VARCHAR(8)),8)+REPLACE(TRANSLATE(TRIM(pt.PAT_NAME),', ','__'	),'.','')+CONVERT(VARCHAR(8),CAST(enc.Load_Dtm AS DATE),112)
...
SELECT DISTINCT
    ...
    CAST(enc.ucinn_ascendv2__Guarantor_ID__c AS VARCHAR(100))				AS ucinn_ascendv2__Guarantor_ID__c,
    ...
    CAST(enc.ucinn_ascendv2__Related_Interim_1__c AS VARCHAR(255))	AS ucinn_ascendv2__Related_Interim_1__c,
