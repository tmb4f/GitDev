...
SELECT
    ...
    CASE WHEN ucinn_ascendv2__Discharge_Date_Time__c IS NOT NULL
			   ...
			   WHEN enc.ucinn_ascendv2__Appointment_Status__c IN ('Scheduled','Completed','Canceled','Arrived')
...
ORDER BY	enc.ucinn_ascendv2__Appointment_Status__c, enc.ucinn_ascendv2__Admit_Date_Time__c
END
